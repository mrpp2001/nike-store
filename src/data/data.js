...
const heroapi = {
  ...
  sociallinks: [
    { icon: facebook,facebook: "https://www.facebook.com/nike"},
    // { icon: messenger },
    { icon: instagram , instagram: "https://www.instagram.com/nike"},
    { icon: twitter,twitter: "https://twitter.com/Nike" },
    { icon: youtube , youtube: "https://www.youtube.com/user/nike"},
  ],
